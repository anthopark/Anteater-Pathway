...
namespace AnteaterPathwayAPI.IntegrationTests
{
    public class CourseDownloaderTests
    {
        ...
        private const string _catalogueScriptDirectory =
            "../../../../AnteaterPathwayAPI/CourseDataScripts/";
        ...
        public CourseDownloaderTests()
        {
            _catalogueDownloader = new CourseDataDownloader(
                _catalogueScriptName, _catalogueScriptDirectory, _catalogueOutputDirecotory);

            _offeringDownloader = new CourseDataDownloader(
                _offeringScriptName, _offeringScriptDirectory, _offeringOutputDirecotory);
        }
